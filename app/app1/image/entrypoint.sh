...
if [[ -z ${1} ]]; then
  ...
  curl -X POST -H 'Content-type: application/json' --data '{"text":"'${hostname}' - Container deployed"}' https://hooks.slack.com/services/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 #MINE
  curl -X POST -H 'Content-type: application/json' --data '{"text":"'${hostname}' - Container deployed"}' https://hooks.slack.com/services/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 #CHEWY
  echo "Starting nginx..."
